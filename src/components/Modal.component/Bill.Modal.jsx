...
import { changeBillStatus, setModalDisplay } from '../../redux/modalSlice'
...
const BillModal = () => {
  ...
  useEffect(() => {
    ...
    setHeight({
      bill: document.getElementById('billComponent').offsetHeight,
  ...
  const closeWindow = () => {
    ...
    dispatch(changeBillStatus(false))
  ...
  return (
    <div id="billModal" >
      ...
      <div className='bill-close-modal'>
        <div className='font-small strong bg-white' style={{
        ...
        <div style={{
          overflowX: billHeight.modal > height ? 'scroll' : '',
